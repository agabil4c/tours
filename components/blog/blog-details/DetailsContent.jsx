    ...
    <>
      ...
      <div className="quote mt-30 mb-30">
        ...
        <div className="quote__icon">
          <Image src="/img/misc/quote-light.svg"  alt="icon"/>
        </div>
      ...
      <div className="row y-gap-30 pt-30">
        <div className="col-md-6">
          <Image src="/img/blog/single/2.png"  alt="image" className="rounded-4" />
          <div className="text-15 mt-10">
            Donec purus posuere nullam lacus aliquam.
          </div>
        </div>
        <div className="col-md-6">
          <Image src="/img/blog/single/3.png"  alt="image" className="rounded-4" />
          <div className="text-15 mt-10">
            Donec purus posuere nullam lacus aliquam.
          </div>
        </div>
